    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(&game->getBoard(),
            &Board::livingCellsCountUpdated,
            this,
            &MainWindow::updateLivingCellsLCD);
...
void MainWindow::setupTable(int width, int height)
{
    ...
    ui->gameTable->horizontalHeader()->setSectionResizeMode(
        QHeaderView::Stretch);  // Ustawienie rozciągliwego rozmiaru kolumn i wierszy
...
void MainWindow::on_startButton_clicked()
{
    if (!game->getIsRunning()) {
        disconnect(ui->startButton,
                   &QPushButton::clicked,
                   game,
                   &GameOfLife::start);  // Odłącz istniejące połączenie
